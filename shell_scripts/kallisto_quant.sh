...
rm -r $2/$1.kallisto/*
mkdir $2/$1.kallisto/31;
mkdir $2/$1.kallisto/25;
mkdir $2/$1.kallisto/15;

kallisto quant -i ../gencode_kallisto_index/31mer_index.kallisto -b 100 -o $2/$1.kallisto/31 -l 200 -s 10 --single -t 23 $3/$1
...
kallisto pseudo -i ../gencode_kallisto_index/31mer_index.kallisto -o $2/$1.kallisto/31 -l 200 -s 10 --single -t 23 $3/$1
...
echo "31mer" > $2/$1.kallisto.cmp_abundance.txt
cat $2/$1.kallisto/31/abundance.tsv | grep OPN1LW >> $2/$1.kallisto.cmp_abundance.txt
cat $2/$1.kallisto/31/abundance.tsv | grep OPN1MW >> $2/$1.kallisto.cmp_abundance.txt
...
echo "31mer" > $2/$1.kallisto.ec_quick_look.txt
cat $2/$1.kallisto/31/pseudoalignments.tsv | grep 199094 >> $2/$1.kallisto.ec_quick_look.txt
cat $2/$1.kallisto/31/pseudoalignments.tsv | grep 199095 >> >> $2/$1.kallisto.ec_quick_look.txt
cat $2/$1.kallisto/31/pseudoalignments.tsv | grep 199096 >> >> $2/$1.kallisto.ec_quick_look.txt
cat $2/$1.kallisto/31/pseudoalignments.tsv | grep 199098 >> $2/$1.kallisto.ec_quick_look.txt
cat $2/$1.kallisto/31/pseudoalignments.tsv | grep 199099 >> >> $2/$1.kallisto.ec_quick_look.txt
cat $2/$1.kallisto/31/pseudoalignments.tsv | grep 199100 >> >> $2/$1.kallisto.ec_quick_look.txt
cat $2/$1.kallisto/31/pseudoalignments.tsv | grep 199102 >> $2/$1.kallisto.ec_quick_look.txt
cat $2/$1.kallisto/31/pseudoalignments.tsv | grep 199103 >> >> $2/$1.kallisto.ec_quick_look.txt
cat $2/$1.kallisto/31/pseudoalignments.tsv | grep 199104 >> >> $2/$1.kallisto.ec_quick_look.txt
cat $2/$1.kallisto/31/pseudoalignments.tsv | grep 199106 >> >> $2/$1.kallisto.ec_quick_look.txt
