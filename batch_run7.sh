...
#	time fastqc --outdir ./quantification/$i/qc ./raw_data/$i
	...
	kallisto quant -i gencode_transcript_index.kallisto -b 100 -o ../quantification/100bootstrap/$i -l 200 -s 10 --single -t 20 ~/data/bbrener1/johnston_retina/raw_data/$i
done
